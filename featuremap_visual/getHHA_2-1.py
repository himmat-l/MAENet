...
'''
def getImage(root = './fullres'):
    D = cv2.imread(os.path.join(root, '0000075.png'), cv2.COLOR_BGR2GRAY)/10000
    RD = cv2.imread(os.path.join(root, '0000075depthWarpRaw.png'), cv2.COLOR_BGR2GRAY)/10000
    return D, RD
...
if __name__ == "__main__":
    ...
    cv2.imwrite('./fullres/hha_SUN.png', hha)
    cv2.imwrite('./fullres/hha_complete_SUN.png', hha_complete)
